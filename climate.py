...
DEFAULT_FAN_MODES = ["OFF", "AUTO", "LOW", "HIGH"]

Spanet = cg.global_ns.class_(
    "Spanet", climate.Climate, cg.PollingComponent
)
...
CONFIG_SCHEMA = climate.CLIMATE_SCHEMA.extend(
    {
        ...
        cv.Optional(CONF_UPDATE_INTERVAL, default="30000ms"): cv.All(
            cv.update_interval, cv.Range(max=cv.TimePeriod(milliseconds=60000))
        ),
